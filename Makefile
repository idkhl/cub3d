...
#    Updated: 2025/01/03 16:34:05 by idakhlao         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = cub3D

SRCS = src/prout.c src/raycasting.c src/raycasting_utils.c src/calc.c src/movement.c src/texture.c src/handle_keys.c src/minimap.c
